# Historical design narrative — not release evidence

This previous README is retained for design history. Its capability claims and
numerical examples are superseded by REVIEW_STATUS.md, the current root README,
and measured evidence. Relative links retain their original root layout.
