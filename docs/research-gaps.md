...
| **GAP-07** | Cross-tokenizer logit distillation | **Avoided safely** — the planner defaults to sequence-level KD and Gate 2 refuses cross-family `logit_kd` outright | Either a validated cross-tokenizer method, or accept catalogue narrowing |
